...
router.get("/:idAgencia/downloadCSV", function (req, res) {
    gerenteController.downloadCSV(req, res);
});

router.get("/:idAgencia/mostrarCountTotal", function (req, res) {
    gerenteController.mostrarCountTotal(req, res);
});

router.get("/:idAgencia/mostrarCount", function (req, res) {
    gerenteController.mostrarCount(req, res);
});

router.get("/:idAgencia/historico", function (req, res) {
    gerenteController.historico(req, res);
});

// === ROTAS DO JIRA ===

router.get("/jira/resolution-data", function (req, res) {
    gerenteController.buscarDadosJira(req, res);
});

router.get("/jira/tabela-cards", function (req, res) {
    gerenteController.listarAlertasPendentesTabela(req, res);
});
...
router.get(
    "/:componenteAtual/:idAtm/pesquisarConfiguracao",
    function (req, res) {
...
router.get(
    "/:selecionado/:opcao/:idAgencia/filtrarFuncionario",
    function (req, res) {
...
router.get("/:idAgencia/listarAtmsPorAgencia", function (req, res) {
    gerenteController.listarAtmsPorAgencia(req, res);
});
