...
public class UltimoSemestre {

    public List<Captura> organizarUltimoSemestre(List<Captura> listaDias, List<Captura> capturas) {
        Integer fkAtm = null;
        ...
        List<Captura> listaSemestre = new ArrayList<>();
        ...
        for(Captura c : listaDias) {
            ...
            if(lista.size() % 30 == 0) {
                ...
                dataHora = "Mês %d".formatted(listaSemestre.size() + 1);
