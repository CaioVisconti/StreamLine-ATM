...
public class UltimoSemestre {
    ...
    public String transformarUltimoSemestre(String sourceBucket, String arq, String[] separacao, LambdaLogger logger) {
        ...
        arq = "%s/ultimoSemestre/%s/Capturas.json".formatted(arq, dir);
