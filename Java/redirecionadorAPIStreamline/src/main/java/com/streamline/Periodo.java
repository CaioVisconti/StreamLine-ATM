...
public class Periodo {
    ...
    public String transformarPeriodo(List<Captura> listaCapturas, String sourceBucket, String arq, String[] separacao, LambdaLogger logger) {
        logger.log("entrouTranformarPeriodo");
        ...
        logger.log(separacao[3]);
        logger.log(separacao[4]);
...
//
        ...
        for(InputStream input : arquivos) {
